...
- **Prod infra appsets pin to a feature branch** during rollout ([`main`](appsets/prod/tenant-a/infrastructure-appset.yaml:12)) rather than `HEAD`; dev infra appsets track `HEAD`.
