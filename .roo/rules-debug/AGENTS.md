...
- **Production `selfHeal: false`** ([`bootstrap/prod/root-app.yaml`](bootstrap/prod/root-app.yaml:19)) means ArgoCD won't auto-correct drift in prod — you must manually sync or trigger a refresh.
